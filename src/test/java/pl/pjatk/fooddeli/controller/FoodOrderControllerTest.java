...
class FoodOrderControllerTest {
    ...
    void placeOrder() throws Exception {
        // We need this restaurant object for comparison with our response JSON in mockMvc so we know values are saved
        // Moved to variable for reading optimization
        ...
        // Mock all external methods from other services (internal methods will be handled by mocks)
        ...
        when(foodOrderService.getDistanceFromBingMaps(anyString(), anyString())).thenReturn(10.0F);
